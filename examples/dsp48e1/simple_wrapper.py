...
from myhdl import intbv, Signal, always_seq, instance
...
def SimpleWrapper(A, B, P, clock_enable, reset, clock):
    ...
    try:
        SimpleWrapper.vhdl_dependencies = DSP48E1.vhdl_dependencies
    except:
        SimpleWrapper.vhdl_dependencies = ()

    try:
        SimpleWrapper.ip_dependencies = DSP48E1.ip_dependencies
    except:
        SimpleWrapper.ip_dependencies = ()
